...
<div class="wrapper" style="margin-left:30%;margin-top:12.5%">
    ...
    <form:form id="empform" action="save" modelAttribute="Employee">
        <label>Name&nbsp;&nbsp;</label><form:input type="text" path="name"
                                                   placeholder="enter the name of the employee"/><br/><br/><br/>
        <label>Salary&nbsp;</label><form:input type="number" path="salary"
                                               placeholder="enter the salary in rupees"/><br/><br/><br/>
